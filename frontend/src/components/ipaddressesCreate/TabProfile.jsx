...
import { ipaddressCreatePrivacyOptions, ipaddressListStatusOptions, ipaddressListTagsOptions } from '@/utils/options'
...
const TabProfile = () => {
    ...
    const group = ipaddressListTagsOptions
    const status = ipaddressListStatusOptions
        ...
        <div className="tab-pane fade show active" id="profileTab" role="tabpanel">
            ...
            <div className="card-body additional-info">
                ...
                <div className="row mb-0 align-items-center">
                    ...
                    <div className="col-lg-8">
                        <SelectDropdown
                            options={ipaddressCreatePrivacyOptions}
                            selectedOption={selectedOption}
