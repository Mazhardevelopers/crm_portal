...
import { salesProfileOption } from './SaleSocalMedia'
import Dropdown from '@/components/shared/Dropdown'
import { FiUserPlus } from 'react-icons/fi'
import { teamMembersList } from '@/utils/fackData/teamMembersList'

const SaleSocalFlower = () => {
    return (
        <div className="card stretch stretch-full">
            <div className="card-header">
                <h2 className="card-title">Suggestions</h2>
                <Dropdown dropdownItems={salesProfileOption} triggerPosition='25,25' dropdownMenuStyle={"wd-250"} />
            </div>
...
export default SaleSocalFlower