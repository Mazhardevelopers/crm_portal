...
import TabNotificationsContent from '../headOfficesView/TabNotificationsContent'
import TabConnections from '../headOfficesView/TabConnections'
import TabBillingContent from '../headOfficesView/TabBillingContent'

const HeadOfficesCreateContent = () => {
    return (
...
export default HeadOfficesCreateContent