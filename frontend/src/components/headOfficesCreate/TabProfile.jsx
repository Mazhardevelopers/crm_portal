...
import { headOfficeCreatePrivacyOptions, headOfficeListStatusOptions, headOfficeListTagsOptions } from '@/utils/options'
...
const TabProfile = () => {
    ...
    const group = headOfficeListTagsOptions
    const status = headOfficeListStatusOptions
        ...
        <div className="tab-pane fade show active" id="profileTab" role="tabpanel">
            ...
            <div className="card-body additional-info">
                ...
                <div className="row mb-0 align-items-center">
                    ...
                    <div className="col-lg-8">
                        <SelectDropdown
                            options={headOfficeCreatePrivacyOptions}
                            selectedOption={selectedOption}
