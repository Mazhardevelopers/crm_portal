...
import { applicantCreatePrivacyOptions, applicantListStatusOptions, applicantListTagsOptions } from '@/utils/options'
...
const TabProfile = () => {
    ...
    const group = applicantListTagsOptions
        ...
        <div className="tab-pane fade show active" id="profileTab" role="tabpanel">
            ...
            <div className="card-body additional-info">
                ...
                <div className="row mb-0 align-items-center">
                    ...
                    <div className="col-lg-8">
                        <SelectDropdown
                            options={applicantCreatePrivacyOptions}
                            selectedOption={selectedOption}
