...
import TabNotificationsContent from '../applicantsView/TabNotificationsContent'
import TabConnections from '../applicantsView/TabConnections'
import TabBillingContent from '../applicantsView/TabBillingContent'

const ApplicantsCreateContent = () => {
    return (
...
export default ApplicantsCreateContent