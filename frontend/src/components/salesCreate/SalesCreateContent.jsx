...
import TabNotificationsContent from '../salesView/TabNotificationsContent'
import TabConnections from '../salesView/TabConnections'
import TabBillingContent from '../salesView/TabBillingContent'

const SalesCreateContent = () => {
    return (
...
export default SalesCreateContent