...
import headOfficeStatistics from '../widgetsStatistics/headOfficeStatistics';
        ...
        <>
            <div className="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                ...
                <Dropdown
                    ...
                    isAvatar={false}
                />
                <Link href="/headOffices/create" className="btn btn-primary">
                    <FiPlus size={16} className='me-2' />
                    <span>Create Head Office</span>
                </Link>
            </div>
...
export default headOfficesHeader