...
import { headOfficesTableData } from '@/utils/fackData/headOfficesTableData';
...
const headOfficesTable = () => {
        ...
        },
        {
            ...
            cell: info => (
                <div className="hstack gap-2 justify-content-end">
                    <Link href="/head-offices/view" className="avatar-text avatar-md">
                        <FiEye />
                    </Link>
    ...
    return (
        <div>
            <Table data={headOfficesTableData} columns={columns} />
        </div>
    )
}

export default headOfficesTable