...
import IpaddressSocalMedia from './IpaddressSocalMedia'
...
import IpaddressSocalFlower from './IpaddressSocalFlower'

const IpaddressContent = () => {
    return (
        <>
            <div className="col-xxl-4 col-xl-6">
                <Profile />
                <IpaddressSocalMedia />
                <IpaddressSocalFlower />
            </div>
...
export default IpaddressContent