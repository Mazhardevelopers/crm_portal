...
import { permissionsTableData } from '@/utils/fackData/permissionsTableData';
...
const PermissionsTable = () => {
        ...
        },
        {
            ...
            cell: info => (
                <div className="hstack gap-2 justify-content-end">
                    <Link href="/permissions/view" className="avatar-text avatar-md">
                        <FiEye />
                    </Link>
    ...
    return (
        <div>
            <Table data={permissionsTableData} columns={columns} />
        </div>
    )
}
