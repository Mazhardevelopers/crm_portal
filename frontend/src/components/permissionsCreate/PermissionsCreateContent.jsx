...
import TabNotificationsContent from '../unitsView/TabNotificationsContent'
import TabConnections from '../unitsView/TabConnections'
import TabBillingContent from '../unitsView/TabBillingContent'

const PermissionsCreateContent = () => {
    return (
...
export default PermissionsCreateContent