...
import { permissionCreatePrivacyOptions, permissionListStatusOptions, permissionListTagsOptions } from '@/utils/options'
...
const TabProfile = () => {
    ...
    const group = permissionListTagsOptions
    const status = permissionListStatusOptions
        ...
        <div className="tab-pane fade show active" id="profileTab" role="tabpanel">
            ...
            <div className="card-body additional-info">
                ...
                <div className="row mb-0 align-items-center">
                    ...
                    <div className="col-lg-8">
                        <SelectDropdown
                            options={permissionCreatePrivacyOptions}
                            selectedOption={selectedOption}
