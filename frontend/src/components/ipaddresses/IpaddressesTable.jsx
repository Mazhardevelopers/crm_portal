...
import { ipaddressesTableData } from '@/utils/fackData/ipaddressesTableData';
...
const IpaddressesTable = () => {
        ...
        },
        {
            ...
            cell: info => (
                <div className="hstack gap-2 justify-content-end">
                    <Link href="/applicants/view" className="avatar-text avatar-md">
                        <FiEye />
                    </Link>
    ...
    return (
        <div>
            <Table data={ipaddressesTableData} columns={columns} />
        </div>
    )
}
